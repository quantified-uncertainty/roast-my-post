...
// Claude Code uses Claude 4 models
const PRICING = {
    'claude-4-opus': {
        input: 15.00 / 1_000_000,    // $15 per 1M input tokens (estimate)
        output: 75.00 / 1_000_000    // $75 per 1M output tokens (estimate)
    },
    'claude-4-sonnet': {
        input: 3.00 / 1_000_000,     // $3 per 1M input tokens (using Claude 3.5 Sonnet pricing)  
        output: 15.00 / 1_000_000    // $15 per 1M output tokens (using Claude 3.5 Sonnet pricing)
    },
    'claude-4-haiku': {
        input: 0.25 / 1_000_000,     // $0.25 per 1M input tokens (estimate)
        output: 1.25 / 1_000_000     // $1.25 per 1M output tokens (estimate)
    },
...
function estimateTaskCost(taskType, model = 'claude-4-sonnet') {
...
function estimateDocumentCost(documentPath, outputDir) {
    ...
    const pricing = PRICING['claude-4-sonnet'];
