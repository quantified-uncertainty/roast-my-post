import type { CheckSpellingGrammarInput } from '../../src/tools/check-spelling-grammar';
...
export const testCases: TestCase[] = [
  ...
  },
  {
    ...
    expectations: {
      shouldFindErrors: false, // Flexible - some consider this acceptable
      maxErrors: 1,
      mustFind: []
    },
  ...
  },
  {
    ...
    expectations: {
      shouldFindErrors: false, // May flag factual error with high importance
      maxErrors: 1
    },
