...
We are Quantified Uncertainty Research Institute ("**Company**," "**we**," "**us**," "**our**"), a company registered in California, United States at 2418 Dana St, Berkeley, CA 94704.

We operate the website at [https://roastmypost.org](https://roastmypost.org/), as well as any other related products and services that refer or link to these legal terms (the "**Legal Terms**") (collectively, the "**Services**").

You can contact us by phone at 269-405-0048, email at ops@quantifieduncertainty.org, or by mail to 2418 Dana St, Berkeley, CA 94704, United States.
...
[8\. RIGHTS REGARDING USER CONTENT](#8.-rights-regarding-user-content)  
[9\. PRIVATE CONTENT](#9.-private-content)  
[10\. DMCA TAKEDOWN NOTICES](#10.-dmca-takedown-notices)  
...
Subject to your compliance with these Legal Terms, including the "[PROHIBITED ACTIVITIES](https://www.roastmypost.org/terms#prohibited)" section below, we grant you a non-exclusive, non-transferable, revocable license to:
...
Users can terminate their account and stop using the Service at any time by using the tools provided for account termination on this Website, or directly contacting the Company at the contact details provided in this document.
...
Users are solely liable for any content they upload, post, share, or provide through the Services. Users acknowledge and accept that the Company does not filter or moderate such content.

However, the Company reserves the right to remove, delete, or block such content at its own discretion and, without prior notice, to deny the uploading User access to the Services:
...
* Where the Company is made aware that the content, while being accessible via the Services, may represent a risk for Users, third parties and/or the availability of the Service.
...
Users agree to hold the Company harmless from and against any claim asserted and/or damage suffered due to content they provided to or provided through the Services.

7. **CONTRIBUTION LICENSE**

**Limited License for Service Operation**

Users acknowledge and accept that by providing their own content on the Services they grant the Company a non-exclusive, fully paid-up and royalty-free license to process such content solely for the operation and maintenance of the Services as contractually required.

This limited license includes only the technical rights necessary to:

* Store and backup your content  
* Transmit your content when you access it  
* Perform routine maintenance and technical operations  
* Comply with legal obligations

We do not claim any ownership rights over your Contributions. You retain full ownership of all of your Contributions and any intellectual property rights or other proprietary rights associated with your Contributions.
...
8. **RIGHTS REGARDING USER CONTENT**

Unless where explicitly stated otherwise, any intellectual property rights, such as copyrights, trademark rights, patent rights and design rights related to content provided by Users belong exclusively to the Users or their licensors.

Users retain all ownership rights in their content. The limited license granted in Section 7 does not transfer any ownership rights to us.

9. **PRIVATE CONTENT**

**Privacy of User Content**

Private content provided by Users shall stay private and will not be shared with any third parties or accessed by the Company without the User's explicit consent, except as required by law or as necessary to provide technical services (such as backup and storage).

The Company does not routinely access, view, scan, or analyze private user content for any purpose other than technical operation and legal compliance.

Users may check on the Services to find details of who can access the content they provide. The type of access to provided content can be modified on the Services.

**When We May Access Private Content**

We may access private user content only in the following limited circumstances:

* When required by law or legal process (such as a valid subpoena or court order)  
* To respond to valid DMCA takedown notices  
* When technically necessary to provide the service (e.g., backup, migration, troubleshooting with your permission)  
* To investigate violations of these Terms that pose security risks or harm to other users  
* With your explicit consent

10. **DMCA TAKEDOWN NOTICES**

**Copyright Policy**

We respect the intellectual property rights of others. If you believe that any content on the Services infringes upon your copyrights, you may submit a notification pursuant to the Digital Millennium Copyright Act ("DMCA") by providing our Copyright Agent with the following information in writing (see 17 U.S.C 512(c)(3) for further detail):
...
4. Information reasonably sufficient to permit the Company to contact the notifying party, such as an address, telephone number, and, if available, an electronic mail;  
5. A statement that the notifying party has a good faith belief that use of the material in the manner complained of is not authorized by the copyright owner, its agent, or the law; and  
...
Copyright infringement notifications may be addressed to our Copyright Agent at:

Name: Ozzie Gooen  
Address: 2418 Dana St, Berkeley, CA 94704  
Email: [ops@quantifieduncertainty.org](mailto:ops@quantifieduncertainty.org)  
Phone: 269-405-0048

**Counter-Notices**

If you believe that content you posted was removed in error or misidentification, you may submit a counter-notice to our Copyright Agent containing the following information:
...
5. A statement that you consent to the jurisdiction of the Federal District Court for the judicial district in which your address is located (or if outside the US, for any judicial district in which the Services may be found), and that you will accept service of process from the person who provided the original DMCA notification or an agent of such person.
...
We may assign any or all of our rights and obligations to others at any time. You may not assign, transfer, or delegate any of your rights or obligations under these Legal Terms without our prior written consent, and any attempted assignment in violation of this clause shall be null and void.
...
export const metadata: Metadata = {
  title: "Terms of Service - Roast My Post",
  description: "Terms of Service for Roast My Post - AI-powered document review and evaluation tools",
};
