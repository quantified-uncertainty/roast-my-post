...
const claimEvaluationsDoc = `# Claim Evaluations API
  ...
  return (
    <div className="rounded-lg bg-white p-8 shadow-sm">
      <div className="mb-6 flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-900">Claim Evaluations</h1>
        <CopyMarkdownButton content={claimEvaluationsDoc} />
      </div>
