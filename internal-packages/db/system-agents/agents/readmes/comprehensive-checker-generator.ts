/**
 * Programmatic README generator for Comprehensive Checker Agent
 * This is in the db package since it's an agent-level combination, not a plugin
 */

export function generateReadme(): string {
  return `# Comprehensive Checker
