...
**Processing Limits:**
- Maximum issues to process: **25**
- Maximum issues per chunk: **15**

**Severity Scoring (0-100):**
- Critical: **80+** (egregious manipulation seriously distorting reality)
- High: **60-79** (clear, significant reasoning error affecting core claims)
- Medium: **40-59** (moderate issue, usually skipped)
- Low: **Below 40** (skipped)

**Confidence Requirements:**
- Critical issues (80+): Require **85+** confidence
- High issues (60+): Require **70+** confidence
- Medium issues (40+): Require **50+** confidence
- Low issues: Require **30+** confidence

**Importance Thresholds:**
- Nitpick threshold: **Below 30**
...
- **Error** - Critical issues (severity 80+) or high-severity misinformation/deception
- **Warning** - Important issues (importance 75-89)
- **Nitpick** - Lower importance issues (importance 30-74)
- **Debug** - Very low importance (below 30)
