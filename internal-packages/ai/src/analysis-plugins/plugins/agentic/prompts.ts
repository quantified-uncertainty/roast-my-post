 ...
 *
 * All prompt text for the orchestrator and sub-agents lives here.
 * Orchestrator.ts imports these and wires them into SDK options.
 */

// ---------------------------------------------------------------------------
// Single-agent system prompt (used when enableSubAgents: false)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Orchestrator agent briefs — short descriptions shown in the orchestrator prompt
// ---------------------------------------------------------------------------

export const ORCHESTRATOR_AGENT_BRIEFS: Record<string, string> = {
...
export const ORCHESTRATOR_MCP_AGENT_BRIEFS: Record<string, string> = {
 ...
 */
export function buildOrchestratorPrompt(enabledAgents: string[]): string {
 ...
 */
export function buildOrchestratorMcpAddendum(enabledAgents: string[]): string {
  const agentBullets = enabledAgents
...
export const SUBAGENT_DESCRIPTIONS: Record<string, string> = {
...
// ---------------------------------------------------------------------------
// Per-agent workspace instructions (file paths, what to read/write)
// ---------------------------------------------------------------------------

export function getWorkspaceInstructions(agentName: string, workspacePath: string, hasFactChecker: boolean): string {
...
// ---------------------------------------------------------------------------
// Per-agent MCP tool usage instructions
// ---------------------------------------------------------------------------

export function getMcpToolInstructions(agentName: string): string {
  switch (agentName) {
    case "fact-checker":
