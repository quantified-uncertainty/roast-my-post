...
jest.mock('./generator', () => ({
  generateForecastWithAggregation: jest.fn()
}));
...
describe('ForecasterTool', () => {
  ...
  describe('hooks', () => {
    it('should call beforeExecute hook', async () => {
      ...
      (generateForecastWithAggregation as jest.Mock).mockResolvedValueOnce({
  ...
  describe('error handling', () => {
    it('should handle forecast generation errors', async () => {
      ...
      (generateForecastWithAggregation as jest.Mock).mockRejectedValueOnce(error);
