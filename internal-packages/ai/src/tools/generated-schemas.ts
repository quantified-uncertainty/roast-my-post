    ...
    "inputSchema": {
      ...
      "properties": {
        "documentText": {
          "type": "string",
          "minLength": 1,
          "description": "The full document text being analyzed for epistemic issues"
        },
        "comments": {
          "type": "array",
          "items": {
            ...
            "properties": {
              "index": {
                "type": "number",
                "description": "Comment index in the original array (0-based)"
              },
              "header": {
                "type": "string",
              ...
              "description": {
                "type": "string",
                "description": "Detailed explanation of the epistemic issue"
              },
              "level": {
                "type": "string",
                "enum": [
              ...
              "importance": {
                "type": "number",
                "description": "Importance score from 0-100 (higher = more important)"
              },
              "quotedText": {
                "type": "string",
                "description": "The exact text from the document that has the issue"
              }
            },
            "required": [
              "index",
    ...
    "outputSchema": {
      ...
      "properties": {
        "commentIndicesToKeep": {
          ...
          "description": "Indices of comments to keep after filtering redundant/weak ones"
        },
        "documentSummary": {
          "type": "string",
          "minLength": 200,
          "maxLength": 800,
          "description": "Comprehensive 200-600 word analysis of the document's overall epistemic quality"
        },
        "oneLineSummary": {
          "type": "string",
          "minLength": 20,
          "maxLength": 200,
          "description": "One-sentence summary capturing the essence of the epistemic evaluation"
        }
      },
      "required": [
        "commentIndicesToKeep",
    ...
    "outputSchema": {
      ...
      "properties": {
        "issues": {
          ...
          "description": "Array of extracted epistemic issues with severity, confidence, and importance scores"
        },
        "totalIssuesFound": {
          "type": "number",
          "description": "Total number of potential issues found before filtering"
        },
        "wasComplete": {
          "type": "boolean",
          "description": "Whether the analysis was complete or had to be truncated due to length"
        }
      },
      "required": [
        "issues",
