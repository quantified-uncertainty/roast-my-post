...
export const agent: EvaluationAgent = {
  ...
  version: "1.6",
  description:
    "Evaluates educational content for effectiveness, alignment with learning objectives, and pedagogical soundness. Assesses instructional design and learning progression.",
