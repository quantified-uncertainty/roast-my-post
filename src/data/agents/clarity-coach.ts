...
export const agent: EvaluationAgent = {
  ...
  version: "1.8",
  description:
    "Evaluates the clarity, coherence, and readability of written communication. Provides metrics on readability and identifies opportunities for improved expression.",
