...
export const agent: EvaluationAgent = {
  ...
  version: "2.7",
  description:
    "Evaluates software code for quality, maintainability, and adherence to best practices. Identifies potential bugs, security issues, and opportunities for optimization.",
