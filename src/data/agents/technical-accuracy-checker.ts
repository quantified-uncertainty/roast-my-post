...
export const agent: EvaluationAgent = {
  ...
  version: "2.2",
  description:
    "Verifies technical accuracy in specialized domains including computer science, engineering, and mathematics. Validates terminology, concepts, and technical explanations.",
