...
export const agent: EvaluationAgent = {
  ...
  version: "3.1",
  description:
    "Analyzes logical structure and reasoning within arguments. Identifies logical fallacies, validates argument structure, and assesses inferential connections.",
  iconName: "ScaleIcon",
  capabilities: [
