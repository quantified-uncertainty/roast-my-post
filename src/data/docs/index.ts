...
import doc6PotentialMisconceptionsAboutAiIntellectualsEaForumBots from './doc6-potential-misconceptions-about-ai-intellectuals-ea-forum-bots.json';
...
export const documentsCollection = transformDocumentsCollection({
  documents: [
    ...
    doc6PotentialMisconceptionsAboutAiIntellectualsEaForumBots,
