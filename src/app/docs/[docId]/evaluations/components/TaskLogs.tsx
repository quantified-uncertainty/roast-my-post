    ...
    <div className="space-y-4">
      <div className="space-y-3">
        {selectedVersion.job.tasks.map((task, index) => {
          ...
          const { summary, input, output, llmInteractions, ...meta } = logData;
              ...
              {llmInteractions && llmInteractions.length > 0 && (
                <div className="mt-3">
                  ...
                  <div className="space-y-2">
                    {llmInteractions.map(
                      (interaction: LLMInteraction, idx: number) => (
                        <details key={idx} className="rounded border bg-white">
                          <summary className="cursor-pointer px-3 py-2 hover:bg-gray-50">
                            ...
                            <span className="ml-2 text-sm text-gray-500">
                              ({interaction.validCommentsCount} valid,{" "}
                              {interaction.failedCommentsCount} failed)
                            </span>
                          </summary>
                          <div className="border-t px-3 pb-3">
                            <div className="mt-2">
                              <h6 className="text-sm font-medium">Prompt:</h6>
                              <div className="mt-1 overflow-x-auto rounded bg-gray-50 p-2 text-xs text-gray-600">
                                <ReactMarkdown
                                  ...
                                  components={{
                                    code({
                                      ...
                                      return (
                                        <code
                                          className={
                                            "block overflow-x-auto rounded bg-gray-200 p-2 text-xs"
                                          }
                                          {...props}
                                        >
                                          {children}
...
`}
                            ...
                            <div className="mt-2">
                              <h6 className="text-sm font-medium">Response:</h6>
                              <div className="mt-1 overflow-x-auto rounded bg-gray-50 p-2 text-xs text-gray-600">
                                <ReactMarkdown
                                  remarkPlugins={[remarkGfm]}
                                  rehypePlugins={[rehypeRaw]}
