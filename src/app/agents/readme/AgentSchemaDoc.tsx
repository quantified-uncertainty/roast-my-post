...
const MARKDOWN_CONTENT = `# Agent Schema Documentation
      ...
      <div className="mx-auto max-w-4xl p-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-start justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Agent Schema Documentation</h1>
              <p className="mt-2 text-xl text-gray-600">
                Complete guide to creating and configuring AI agents for document evaluation
              </p>
            </div>
            <button
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
          <h2 className="text-lg font-semibold text-blue-900 mb-3">📋 Copy as Markdown</h2>
          <p className="text-blue-800 mb-4">
            This documentation is designed to be copied as markdown and provided to LLMs for agent creation assistance. 
            Click the "Copy as Markdown" button above to get the full documentation in markdown format.
          </p>
          <div className="text-sm text-blue-700">
            <strong>Use Case:</strong> Paste this documentation into Claude, ChatGPT, or other LLMs along with your specific requirements to get help creating well-structured agents.
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-8">
          <div className="prose prose-sm max-w-none">
            <pre className="whitespace-pre-wrap bg-gray-50 p-6 rounded-lg overflow-x-auto text-xs font-mono">
              {MARKDOWN_CONTENT}
            </pre>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 text-center text-gray-500">
          <p>
            ...
            <Link href="/agents/new" className="text-blue-600 hover:text-blue-800">
              Agent Creator
            </Link>{" "}
            or{" "}
