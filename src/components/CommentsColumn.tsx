...
import { calculateCommentPositions, checkHighlightsReady } from "@/utils/ui/commentPositioning";
...
export function CommentsColumn({
  ...
  useEffect(() => {
    ...
    const checkHighlights = () => {
      ...
      attempts++;
      const isReady = checkHighlightsReady(contentRef.current, sortedComments.length);
  ...
  }, [hoveredCommentId, calculatePositions, highlightsReady, positionsCalculated]);
        ...
        {sortedComments.map((comment, index) => {
          ...
          return (
            <PositionedComment
              ...
              isHovered={isHovered}
              colorMap={commentColorMap[index] || { background: "#gray", color: "#fff" }}
