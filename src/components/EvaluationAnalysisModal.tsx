...
export function EvaluationAnalysisModal({
  isOpen,
  onClose,
  evaluation,
  documentId,
  ...
  const agentDescription = evaluation.agent.description || "";
  const agentType = evaluation.agent.purpose || "";
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div className="relative bg-white rounded-lg shadow-2xl w-[70vw] h-[85vh] flex flex-col overflow-hidden">
          {/* Header */}
