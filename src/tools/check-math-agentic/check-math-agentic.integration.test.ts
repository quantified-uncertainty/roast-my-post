...
describeIfApiKey('CheckMathAgenticTool Integration', () => {
  ...
  describe('Basic Arithmetic Verification', () => {
    it('should verify correct addition', async () => {
      ...
      expect(result.agentReasoning).toBeTruthy();
      expect(result.toolCalls).toBeDefined();
      expect(result.llmInteraction).toBeDefined();
    }, API_TIMEOUT);

    it('should detect incorrect addition', async () => {
      const input: CheckMathAgenticInput = {
        statement: '2 + 2 = 5'
      };
    ...
    it('should verify correct multiplication', async () => {
      const input: CheckMathAgenticInput = {
        statement: '5 × 7 = 35'
      };
    ...
    it('should detect incorrect multiplication', async () => {
      const input: CheckMathAgenticInput = {
        statement: '5 × 7 = 40'
      };
  ...
  describe('Percentage and Unit Calculations', () => {
    it('should verify correct percentage calculation', async () => {
      const input: CheckMathAgenticInput = {
    ...
    it('should detect incorrect percentage calculation', async () => {
      const input: CheckMathAgenticInput = {
    ...
    it('should verify correct unit conversion', async () => {
      const input: CheckMathAgenticInput = {
    ...
    it('should detect incorrect unit conversion', async () => {
      const input: CheckMathAgenticInput = {
    ...
    it('should provide correct answer for unit mismatch errors', async () => {
      const input: CheckMathAgenticInput = {
  ...
  describe('Mathematical Approximations', () => {
    it('should accept reasonable π approximation', async () => {
      const input: CheckMathAgenticInput = {
        statement: 'π ≈ 3.14'
      };
    ...
    it('should detect poor π approximation', async () => {
      const input: CheckMathAgenticInput = {
        statement: 'π ≈ 3.0'
      };
    ...
    it('should accept engineering approximation with context', async () => {
      const input: CheckMathAgenticInput = {
  ...
  describe('Symbolic Math Limitations', () => {
    it('should not verify symbolic derivative statement', async () => {
      const input: CheckMathAgenticInput = {
    ...
    it('should not verify symbolic integral statement', async () => {
      const input: CheckMathAgenticInput = {
    ...
    it('should not verify algebraic identity', async () => {
      const input: CheckMathAgenticInput = {
  ...
  describe('Advanced Mathematical Functions', () => {
    it('should verify correct square root', async () => {
      const input: CheckMathAgenticInput = {
        statement: 'sqrt(16) = 4'
      };
    ...
    it('should detect incorrect square root', async () => {
      const input: CheckMathAgenticInput = {
        statement: 'sqrt(16) = 5'
      };
    ...
    it('should verify correct factorial', async () => {
      const input: CheckMathAgenticInput = {
        statement: '5! = 120'
      };
    ...
    it('should detect incorrect factorial', async () => {
      const input: CheckMathAgenticInput = {
        statement: '5! = 100'
      };
    ...
    it('should verify correct combination calculation', async () => {
      const input: CheckMathAgenticInput = {
    ...
    it('should detect incorrect combination calculation', async () => {
      const input: CheckMathAgenticInput = {
  ...
  describe('Error Categorization and Details', () => {
    it('should categorize logic errors correctly', async () => {
      const input: CheckMathAgenticInput = {
        statement: 'If we flip a coin 10 times, we will definitely get exactly 5 heads'
      };
      ...
      expect(result.explanation).toMatch(/probability|definitely|cannot guarantee/i);
    }, API_TIMEOUT);

    it('should categorize conceptual errors correctly', async () => {
      const input: CheckMathAgenticInput = {
    ...
    it('should provide detailed tool call information', async () => {
      const input: CheckMathAgenticInput = {
        statement: '2^10 = 1024'
      };
      ...
      // Should have at least one evaluate_mathjs call
      const mathJsCall = result.toolCalls!.find(call => call.tool === 'evaluate_mathjs');
      expect(mathJsCall).toBeDefined();
      expect(mathJsCall!.input).toBeDefined();
      expect(mathJsCall!.output).toBeDefined();

      // Should end with a respond call
      const respondCall = result.toolCalls!.find(call => call.tool === 'respond');
      expect(respondCall).toBeDefined();
    }, API_TIMEOUT);
  });

  describe('Complex Statements and Edge Cases', () => {
    it('should handle statements with multiple calculations', async () => {
      const input: CheckMathAgenticInput = {
        statement: 'Given that 2 + 2 = 4 and 3 × 5 = 15, therefore 4 + 15 = 19'
      };
    ...
    it('should detect errors in compound statements', async () => {
      const input: CheckMathAgenticInput = {
    ...
    it('should handle notation ambiguity', async () => {
      const input: CheckMathAgenticInput = {
        statement: '6/2(1+2) = 9'
      };
    ...
    it('should handle incomplete expressions gracefully', async () => {
      const input: CheckMathAgenticInput = {
