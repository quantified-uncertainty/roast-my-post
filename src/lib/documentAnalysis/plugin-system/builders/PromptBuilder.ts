...
For each item, determine if it's valid/correct and explain your reasoning.`;
  ...
  private formatItem(item: any): string {
    ...
    let formatted = text || JSON.stringify(item);
  ...
  static forMath(): PromptBuilder {
    return new PromptBuilder(
      "mathematical expressions and calculations",
      "Extract all equations, calculations, and mathematical statements, then verify their correctness",
      [
